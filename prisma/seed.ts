...
async function main() {
  ...
  const shiftTypesData = [
    { name: 'MORNING SHIFT', startTime: '8:00 AM', endTime: '5:00 PM', colorHex: '#94A3B8', isRotating: false, sortOrder: 1 }, // Slate/Gray
    { name: 'DAY SHIFT', startTime: '6:00 AM', endTime: '3:00 PM', colorHex: '#22C55E', isRotating: true, sortOrder: 2 }, // Green
    { name: 'MID SHIFT', startTime: '2:00 PM', endTime: '11:00 PM', colorHex: '#F97316', isRotating: true, sortOrder: 3 }, // Orange
    { name: 'ADJUST SHIFT', startTime: null, endTime: null, colorHex: '#EF4444', isRotating: true, sortOrder: 4 }, // Red
    { name: 'NIGHT SHIFT', startTime: '8:30 PM', endTime: '5:30 AM', colorHex: '#A855F7', isRotating: true, sortOrder: 5 }, // Purple
    { name: 'MIDNIGHT SHIFT', startTime: '10:00 PM', endTime: '7:00 AM', colorHex: '#3B82F6', isRotating: true, sortOrder: 6 }, // Blue
    { name: 'LEAVE', startTime: null, endTime: null, colorHex: '#D8B4FE', isRotating: false, sortOrder: 7 }, // Lavender
  ];
