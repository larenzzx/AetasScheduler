...
export default function UnsavedChangesBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-6 md:left-[280px] right-6 z-50 flex flex-col sm:flex-row gap-4 sm:items-center justify-between rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 shadow-lg backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-300">
